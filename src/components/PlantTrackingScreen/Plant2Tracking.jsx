...
const Plant2Tracking = () => {
    ...
    useEffect(() => {
        ...
        const humidityStatusRef = ref(db, 'Sensors/HumiditySensors/HumiditySensorTwo');
        const LightStatus = ref(db, 'Sensors/LightSensors/LightSensorTwo');
    ...
    return (
        <View>
            <View style={{ width: 500, height: 400, backgroundColor: '#D6E4E8', padding: 15, borderBottomLeftRadius: 70 }}>
